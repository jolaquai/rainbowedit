...
internal class EnumStringificationException<TEnum> : Exception
{
    ...
    /// <summary>
    /// Instantiates a new <see cref="EnumStringificationException{TEnum}"/> with a given <typeparamref name="TEnum"/> and <paramref name="string"/>.
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="EnumStringificationException{TEnum}"/> with a given <paramref name="string"/>.
    /// </summary>
